...
if __name__ == "__main__":
    ...
    output_path = "../../output/vlm_nl/vlm_response.json"
    ...
    Carefully analyse all visual details from the images, and reurn the ordered robot actions that the robot must perform to complete the task, such that: each step is a single, atomic, clear action; the plan is physically and logically valid; actions reference specific objects and locations based on the environment description.
