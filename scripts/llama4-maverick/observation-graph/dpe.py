...
def define_schema():
    entities = ["Environment", "Component", "Appliance", "Furniture", "Object", 
                "Location", "CurrentLocation", "StandardLocation", "Affordance", 
                "Closing", "Opening", "Delivering", "Holding", "PickingUp", 
                "PuttingDown", "Pulling", "Pushing", "Grasping"]
    relations = ["hasComponent", "hasAffordance", "hasLocation", 
...
if __name__ == "__main__":
    ...
    output_path = "../../../output/llama4-maverick/observation-graph/dpe"
